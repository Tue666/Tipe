...
const COOPERATION = [
  "Regulations on operation of E-commerce trading floor",
  "Selling with Tipe",
];
  ...
  return (
    <Root>
      ...
      <Inlines>
        ...
        <Typography variant="caption">
          Receive online orders and deliver to your door, not yet support to buy
          and receive goods directly at the office or order processing center
        </Typography>
        <Typography variant="caption">
          Business Registration Certificate No. 0309532909 issued by the
          Department of Planning and Investment of Ho Chi Minh City on
          06/01/2010
        </Typography>
        <Typography variant="caption">
          © 2021 - Copyright by Tipe Company - abc.xyz
        </Typography>
      </Inlines>
      <Divider />
      <Inlines>
        ...
        <Typography variant="caption">
          With millions of products from reputable brands and stores, thousands
          of items from Smartphones to Fresh Fruits and Vegetables, along with
          ShopNOW super-fast delivery service, shop brings you a shopping
          experience. online starts with credit. In addition, at shop you can
          easily use countless other utilities such as buying scratch cards,
          paying electricity and water bills, insurance services.
        </Typography>
        <Typography variant="subtitle2">
          Promotions and offers are overflowing
        </Typography>
        <Typography variant="caption">
          You want to hunt for a shocking price, Shop has a shocking price every
          day for you! You are a fan of brands, genuine Official stores are
          waiting for you. No need to hunt for freeship codes, because shop
          already has millions of products in the Freeship+ program, unlimited
          bookings, saving your precious time. Buy more ShopNOW savings packages
          to receive 100% free shipping 2h same day, or buy premium ShopNOW
          packages to receive 100% freeship, applicable to 100% products, 100%
          provinces in Vietnam. Want to save even more? Already have ShopCARD,
          shop credit card refund 15% on all transactions (maximum refund
          600k/month).
        </Typography>
      </Inlines>
    </Root>
