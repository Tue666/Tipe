...
import { Stars, QuantityInput, FlashSaleSvg } from '@/components';
...
const Information = (props: InformationProps) => {
  ...
  const flashSaleEndTime = flash_sale?.end_time ?? null;
            ...
            {!_.isNil(flashSaleEndTime) && (
              <FlashSale direction="row" alignItems="center" justifyContent="space-between" px={1}>
                ...
                <Stack direction="row" alignItems="start" spacing={1}>
                  ...
                  <FlipCountdownTimer targetTime={flashSaleEndTime} />
                </Stack>
              </FlashSale>
            )}
